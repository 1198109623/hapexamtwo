//package hapexam.core.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "hapexam/core/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType,["com/hand/hap","hapexam/core"] ,["table", "data", "patch"])
